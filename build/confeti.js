				...
				A2(
					...
					A2(
						...
						A2(
							...
							$elm$core$Basics$degrees(direction),
...
var $author$project$Confetti$burst = F2(
	function (_v0, direction) {
		...
		return A2(
			...
			100,
			A3($author$project$Confetti$particleAt, x, y, direction));
	});
...
var $author$project$Main$requestAnimationMsgDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$RequestAnimationMsg,
